...
I have extensive programming expertise with over 15 years development in R, as well experience with multiple other languages, with a focus on developing and maintaining packages that interface with large-scale data containers, and are widely used in the scientific community.
...
- Authored Helm charts for deploying in-house data services on Kubernetes.
