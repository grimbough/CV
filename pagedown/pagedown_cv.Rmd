...
Experience with cloud technologies and containers
...
Worked extensively with out-of-memory representation of large-scale data e.g. HDF5, Zarr
...
As part of the EMBL Data Science Centre, I work closely with experimental researchers, 
scientific core facilities, IT services, and other data management experts to 
harmonise efforts in large-scale integrated biological data management across EMBL’s 
international sites.

<!--
Data Governance & Policy Implementation: Ensuring compliance with institutional, national, and international data policies, including FAIR (Findable, Accessible, Interoperable, and Reusable) principles.
Data Storage & Organization: Overseeing how research data is stored, structured, and archived for accessibility and long-term preservation.
Metadata & Documentation: Establishing best practices for metadata standards and documentation to enhance data usability.
Data Sharing & Security: Managing access control, data sharing agreements, and security protocols to protect sensitive research data.
Collaboration & Training: Supporting researchers in data management planning, providing training on best practices, and facilitating interdisciplinary collaboration.
Workflow Optimization: Streamlining data processing, integrating tools and software, and ensuring efficient data pipelines.
-->
...
- Line managing a small, internationally distributed, team focused on improving
the management of data across the laboratory, from data production to deposition
in public repositories.
- Coordinating the implementation of standardised high-throughput data processing 
frameworks using workflow languages and containerized software in HPC and cloud 
computing environments in order to streamline data processing
- Ensuring compliance with institutional and funding agency data policies, including FAIR (Findable, Accessible, Interoperable, and Reusable) principles.
- Hands on experience with the data management requirements for a wide range of
...
- Delivering training on data management best practices
...
- Mentoring junior software developers, both within EMBL and 
...
- Collaborated with experimental biologists to develope software for the analysis of pooled CRISPR screens
