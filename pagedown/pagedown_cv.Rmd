...
I am also passionate about enabling and educating around good practices for 
reproducible research. I work extensively with version control, containers,
and literate programming tools like R Markdown, and encourage those around me 
...
- Maintained and continued development of several widely used 'infrastructure packages' e.g. [biomaRt](https://bioconductor.org/packages/biomaRt/) and [rhdf5](https://bioconductor.org/packages/rhdf5/). 
...
provided technical support, administered the course website and teaching materials, reviewed applications
